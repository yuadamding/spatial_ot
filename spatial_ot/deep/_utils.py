...
def slice_count_chunk(matrix, row_index: np.ndarray, gene_index: np.ndarray) -> np.ndarray:
...
def sample_gene_chunk(n_genes: int, chunk_size: int, rng: np.random.Generator) -> np.ndarray:
