...
def run_multilevel_ot_on_h5ad(
    ...
    *,
    ...
    result = fit_multilevel_ot(
        ...
        heterogeneity_fused_ot_epsilon=heterogeneity_fused_ot_epsilon,
    ...
    summary = {
        ...
        "heterogeneity_fused_ot_solver": str(heterogeneity_fused_ot_solver),
        "heterogeneity_fused_ot_epsilon": float(heterogeneity_fused_ot_epsilon),
...
def run_multilevel_ot_with_config(config: MultilevelExperimentConfig) -> dict:
    return run_multilevel_ot_on_h5ad(
        ...
        heterogeneity_fused_ot_epsilon=config.ot.heterogeneity_fused_ot_epsilon,
